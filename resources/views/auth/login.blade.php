            ...
            <div class="w-full max-w-4xl">
                <div class="overflow-hidden shadow-lg rounded-2xl bg-white/90 backdrop-blur-lg">
                    <div class="flex flex-col md:flex-row">
                        ...
                        <div
                            class="relative w-full md:w-1/2 bg-gradient-to-br from-[#4A7251]/90 to-[#387ca3]/90 text-white p-8 md:p-20 overflow-hidden">
                        ...
                        <div class="w-full md:w-1/2">
                            <div class="p-4 md:p-20">
                                ...
                                <form method="POST" action="{{ route('login') }}">
                                    ...
                                    <!-- Input Password -->
                                    <div class="mb-4">
                                        <label for="password" class="block mb-1 text-sm font-medium text-gray-700">Kata
                                            Sandi</label>
