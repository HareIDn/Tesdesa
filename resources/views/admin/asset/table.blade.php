...
<div class="overflow-hidden bg-white shadow-sm rounded-xl">
    <div class="p-4 bg-green-50">
        <div class="flex items-center justify-between">
            ...
            <div class="relative">
                <input type="text" placeholder="Search..." class="py-2 pl-8 pr-4 border rounded-lg focus:outline-none focus:ring-2 focus:ring-green-500">
        ...
        <table class="w-full">
            <thead class="bg-green-50">
                <tr>
                    ...
                    <th class="px-6 py-3 text-sm font-semibold text-left text-gray-700">NIK</th>
                    <th class="px-6 py-3 text-sm font-semibold text-left text-gray-700">Jenis Surat</th>
                    <th class="px-6 py-3 text-sm font-semibold text-left text-gray-700">Jam</th>
                    <th class="px-6 py-3 text-sm font-semibold text-left text-gray-700">Dokumen</th>
                </tr>
            </thead>
            <tbody class="divide-y divide-gray-200">
                ...
                <tr class="hover:bg-gray-50">
                    ...
                    <td class="flex items-center px-6 py-4 space-x-2">
                        ...
                        <a href="#" download class="flex items-center text-green-600 hover:text-green-800">
                            <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5 mr-1" fill="none" viewBox="0 0 24 24" stroke="currentColor">
