...
Route::get('sktm',[SubsktmController::class,'index']);
Route::post('/sktm', [SubsktmController::class, 'store']);
Route::get('/sktm/{id}', [SubsktmController::class, 'show']);
Route::put('/sktm/{id}', [SubsktmController::class, 'update']);
Route::delete('/sktm/{id}', [SubsktmController::class, 'destroy']);
...
Route::put('/{userId}/role', [RoleController::class, 'updateUserRole'])->middleware('role:super_admin|manage');
    ...
    Route::prefix('user')->middleware('can:make')->group(function() {
        ...
        Route::get('sktm',[SubsktmController::class,'index'])->middleware('role:user|make');
        Route::post('/sktm', [SubsktmController::class, 'store'])->middleware('role:user|make');
        Route::get('/sktm/{id}', [SubsktmController::class, 'show'])->middleware('role:user|make');
        Route::put('/sktm/{id}', [SubsktmController::class, 'update'])->middleware('role:user|make');
        Route::delete('/sktm/{id}', [SubsktmController::class, 'destroy'])->middleware('role:user|make');
